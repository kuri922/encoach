            ...
            <form method="POST" action="contact/show">
              @csrf
                ...
                <div class="form-group row">
                    <label name="name" class="col-md-5 col-form-label text-md-left">氏名<span class="ml-1 encoach-require-input-label"><span class="encoach-require-input-label-text">必須</span></span></label>
                ...
                <div class="form-group row">
                    <label for="email" class="col-md-5 col-form-label text-md-left">問合せ内容<span class="ml-1 encoach-require-input-label"><span class="encoach-require-input-label-text">必須</span></span></label>
